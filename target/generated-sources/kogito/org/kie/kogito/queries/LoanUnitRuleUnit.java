...
public class LoanUnitRuleUnit extends AbstractRuleUnit<LoanUnit> {
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new org.kie.kogito.queries.RulesF894883E1030542FEFCE9860F835B9B7_LoanUnit(), ruleBaseConfig);
        return kb;
    }
}
